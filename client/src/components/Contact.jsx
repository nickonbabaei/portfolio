...
const Contact = () => {
  return (
    <section class="text-gray-600 body-font bg-gradient-to-b from-cyan-400 to-cyan-700 relative" id='contact'>
      <div class="md:pl-8 pb-24 flex mx-auto max-w-screen-xl md:flex-nowrap flex-wrap">

        <div class="lg:w-2/3 md:w-1/2 sm:h-full rounded-lg justify-center overflow-hidden flex relative mx-auto">
          <iframe className='pt-20 sm:py-0 md:w-full w-96' width="80%" height="600" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=100%25&amp;height=600&amp;hl=en&amp;q=Downtown%20Halifax+()&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"><a href="https://www.maps.ie/distance-area-calculator.html">area maps</a></iframe>
        ...
        <div class="lg:w-1/3 md:w-1/2 drop-blur flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0 px-2 md:pr-8 md:pl-8">
